...
def log_confusion_matrix(cm, dataset_name):
    ...
    cm_file_path = os.path.join("artifacts", f"confusion_matrix_{dataset_name}.png")
...
def main():
    mlflow.set_tracking_uri("http://ec2-3-111-51-158.ap-south-1.compute.amazonaws.com:5000//")
